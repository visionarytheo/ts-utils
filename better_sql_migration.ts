...
async function runMigration() {
  try {
    ...
    console.log(`⏳ Found ${files.length} migration files. Starting execution loop...`);
    ...
    console.log("✅ All schema migrations executed successfully! Structural baselines established.");
  } catch (error) {
